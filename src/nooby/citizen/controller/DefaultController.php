...
class DefaultController extends Controller {
	...
	public function handlePlayerJoin(PlayerJoinEvent $event): void
	{
		...
		$citizens = array_filter($citizenFactory->getFactory()->getAll(), function (Citizen $citizen) use($player){
	...
	public function handleEntityTeleport(EntityTeleportEvent $event): void
	{
		...
		$citizensDespair = array_filter($citizenFactory->getFactory()->getAll(), function (Citizen $citizen) use($origin){
		...
		$citizensSpawn = array_filter($citizenFactory->getFactory()->getAll(), function (Citizen $citizen) use($target) {
